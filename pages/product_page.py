...
class ProductPage(BasePage):
    ...
    def product_must_be_added_to_basket(self):
        ...
        assert product_name_in_message.text == real_product_name.text, \
            "{} real {}".format(product_name_in_message.text, real_product_name.text)
    ...
    def product_price_equal_basket_amount(self):
        ...
        assert basket_amount.text == product_price.text, "{} real {}".format(basket_amount.text, product_price.text)
