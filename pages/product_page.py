...
class ProductPage(BasePage):
    def add_product_to_basket(self):
        """Method for add product to basket
    ...
    def product_must_be_added_to_basket(self):
        """Method to verify that the product has been added to the basket
    ...
    def product_price_equal_basket_amount(self):
        """Method to verify that the product price equal basket amount
    ...
    def should_not_be_success_message(self):
        """Method for checking whether a successful product add message exists
    ...
    def success_message_is_disappear(self):
        """Method for checking that the element has disappeared
